<template>
    ...
    <div class="relative px-4 sm:px-6 lg:px-8">
        ...
        <h1>
            ...
            <span class="mt-2 block text-3xl text-center leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">This is an Article</span>
        </h1>
        ...
        <figure>
            <img class="w-full rounded-lg" :src="pic" alt="" width="1310" height="873">
