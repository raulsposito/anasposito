<template>
    ...
    <div class="relative max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        ...
        <div>
            ...
            <h3 class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">Meet Ana Laura</h3>
        </div>
        </div>
        ...
        <div class="relative lg:row-start-1 lg:col-start-2">
            ...
            <figure>
                ...
                <img class="rounded-lg shadow-lg object-cover object-center" :src="pic" alt="Ana leaning against a railing on a downtown street" width="1184" height="1376">
                </div>
