    ...
    <div class="max-w-7xl mx-auto bg-brand lg:bg-transparent lg:px-8">
        ...
        <div class="relative z-10 lg:col-start-1 lg:row-start-1 lg:col-span-4 lg:py-16 lg:bg-transparent">
            ...
            <div class="aspect-w-10 aspect-h-6 sm:aspect-w-2 sm:aspect-h-1 lg:aspect-w-1">
                <img class="object-cover object-center rounded-3xl shadow-2xl" :src="pic" alt="">
            </div>
            </div>
        </div>

        <div class="relative bg-brand lg:col-start-3 lg:row-start-1 lg:col-span-10 lg:rounded-3xl lg:grid lg:grid-cols-10 lg:items-center">
            ...
            <svg class="absolute bottom-full left-full transform translate-y-1/3 -translate-x-2/3 xl:bottom-auto xl:top-0 xl:translate-y-0" width="404" height="384" fill="none" viewBox="0 0 404 384" aria-hidden="true">
                ...
                <pattern id="64e643ad-2176-4f86-b3d7-f2c5da3b6a6d" x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse">
                    <rect x="0" y="0" width="4" height="4" class="text-brand" fill="currentColor" />
                </pattern>
                </defs>
            ...
            <a class="block w-full py-3 px-5 text-center bg-shadow border border-transparent rounded-md shadow-md text-base font-medium text-white hover:bg-brand hover:text-white hover:bg-gray-50 sm:inline-block sm:w-auto" href="#">Explore open positions</a>
            </div>
        </div>
        </div>
    </div>
